...
-- ==================================================
-- YOKUDO HUB TOGGLE KEYBIND
-- Press L to show/hide the UI
-- ==================================================
...
local function FindYokudoUI()
    for _, gui in ipairs(CoreGui:GetChildren()) do
        if gui:IsA("ScreenGui") and gui.Name ~= "LoadingScreen" then
            if gui.Name:lower():find("yokudo")
                or gui.Name:lower():find("hub")
                or gui.Name:lower():find("main") then
...
local function ToggleUI()
    local YokudoUI = FindYokudoUI()

    if not YokudoUI then
        warn("[YOKUDO] UI not found")
        return
    end

    UIVisible = not UIVisible
    YokudoUI.Enabled = UIVisible
end
